...
public class Schedule: NSObject, NSCoding {
    ...
    public func add(lecture: Lecture, at day: Int){
    ...
    public func daySize(at section: Int) -> Int{
    ...
    public func lecture(at indexPath: IndexPath) -> Lecture{
        return lectures[indexPath.section][indexPath.row]
    }
    
    public func removeLecture(at indexpath: IndexPath){
